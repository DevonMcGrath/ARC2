/* Deadlock occurs around line 600 when
   exchangePos and
   exchangePosAsync
   are called
*/
  ...
  public static void main(String[] args) { // for testing
    ...
    try {
     // System.out.println("inside!");
      ...
      out.write("< XtangoAnimator , finished , SUCCESS >" + "\r\n");
      out.close();
      System.out.println("< XtangoAnimator , finished , SUCCESS >");
    ...
    // Thread.yield();
      ...
      if (XtangoAnimator.i==icon2.position){
        try {
             ...
             out.write("< XtangoAnimator , deadlock occurred , deadlock >" + "\r\n");
             out.close();
            }
        catch (Exception e) {
            e.printStackTrace();
...
/*  abstract
  ...
  abstract void draw(AnimatorCanvas ac, Graphics g);
