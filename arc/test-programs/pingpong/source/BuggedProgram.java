...
public class BuggedProgram {
    ...
    public void doWork() {
        ...
        try {
            ...
            output.writeBytes(String.valueOf(this.bugAppearanceNumber
              + " bugs. " + newLine));
    ...
    // ---------------------------------
    // BUG: This method should be synchronized
    // All threads share a common instance of the BuggedProgram class
    // If pingPongPlayer is null when pingPongPlayer.getI() is called,
