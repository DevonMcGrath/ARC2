...
public class BuggyProgram{
  ...
  // ==============================   Constants   ==============================
  // DK: was 3,33,333. Reduced to 3,10,20 so JPF has a chance
  public static final int    LITTLE_CONCURRENCY=   3,
                             AVERAGE_CONCURRENCY=  10,
                             LOT_CONCURRENCY=      20,
                             MAX_DIGITS=           3,
                             INVALID=              -3;
  ...
  public BuggyProgram(){
    ...
    for (i= 0; i < numOfUsers; i++){   // DK: was ++i
  ...
  public class User extends Thread{
    ...
    public void run(){
      ...
      //-------------------------
      // BUG: generate/present/record manipulate a global variable.
      //      To be consistent a thread musn't be interrupted while
      //      doing so.  This can be achieved by using a shared lock.
      //      ie, if the generated, presented and history arrays
      //      contain different values, a data race occurred
